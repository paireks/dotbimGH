...
{
    public class CreateBimElementsGh : GH_Component
    {
        public CreateBimElementsGh()
            : base("Create Elements Set", "Create Elements Set", "Create Elements Set", "BIM", "Create File")
        {
        }
